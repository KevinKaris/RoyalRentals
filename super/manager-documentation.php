        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Manager Documentation</h3>
            </div>
            <div class="row">
            <div class="col-lg-12">
              <div class="card">
                    ...
                    <div id="accordion-1" class="accordion">
                      <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion-1">
                          <div class="card-body">
                            This system makes it easy for manager to manage tenants, houses and everthing around there. Each Section of this documentation represents each module (menu) and describes how it works. You can go directly to the section(s) you are interested with.
                          </div>
                        </div>
                      </div>
                    </div>
