      ...
      <?php include 'heading.php' ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            $sql = "SELECT * FROM users WHERE id = ? AND user_group = ?";
              ...
              <div class="row">
                    <div class="col-lg-4">
                      <div class="text-center pb-4">
                        ...
                        if($fetch['photo'] != null){
                        ?>
                        <img src="<?php echo '../images/profile-photos/'.$details['photo']?>" alt="profile" class="img-lg rounded-circle mb-3 profile-image"/>
                        <img src="<?php echo '../images/profile-photos/'.$details['photo']?>" alt="profile" class="img-lg rounded-circle mb-3 profile-image2"/>
                        <?php
                        }
                        else{
                        ?>
                        ...
                        <p class="mt-3"><button class="btn btn-light btn-sm" id="remove-photo" value="<?php echo $details['id']?>">Remove Photo</button></p>
                      </div>
                    </div>
                    <div class="col-lg-8 pl-lg-5">
                      <div class="d-flex justify-content-between">
                        <div>
                          <h3><?php echo $details['f_name'].' '.$details['l_name']?></h3>
                        </div>
                      </div>
                      ...
                      <div class="profile-feed">
                        ...
                        <p class="clearfix">
                          ...
                          <span class="float-right text-muted">
                            <input type="text" class="text-muted" id="f-name" value="<?php echo $details['f_name']?>">
                          </span>
                        </p>
                        <p class="clearfix">
                          <span class="float-left">
                          ...
                          <span class="float-right text-muted">
                            <input type="text" class="text-muted" id="l-name" value="<?php echo $details['l_name']?>">
                          </span>
                        </p>
                        <p class="clearfix">
                          <span class="float-left">
                          ...
                          <span class="float-right text-muted">
                            <input type="text" class="text-muted" id="username" value="<?php echo $details['username']?>">
                          </span>
                        </p>
                        <p class="clearfix">
                          <span class="float-left">
                          ...
                          <span class="float-right text-muted">
                            <input type="phone" class="text-muted" id="phone" value="<?php echo '0'.$details['phone']?>">
                          </span>
                        </p>
                        <p class="clearfix">
                          <span class="float-left">
                          ...
                          <span class="float-right text-muted">
                            <input type="email" class="text-muted" id="email" value="<?php echo $details['email']?>">
                          </span>
                        </p>
                        <p class="clearfix">
                          <span class="float-left">
