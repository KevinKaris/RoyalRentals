        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Tenants with balance</h3>
            ...
            <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tenants with balance</h4>
                  <div class="col-md-4 mb-2 d-flex flex-direction-row justify-content-between">
                    <select name="month" id="month" class="form-control col-md-5">
                      <script>
                    ...
                    <select name="year" id="year" class="form-control col-md-5">
                      <?php
                      $currentYear = date('Y');
