(function ($) {
  ...
  $(function () {
    ...
    $(".tiles.primary").on("click", function () {
      ...
      $(this).addClass("selected");
      localStorage.setItem("navTheme", "primary");
    });
    $(".tiles.success").on("click", function () {
      ...
      $(".tiles").removeClass("selected");
      $(this).addClass("selected");
      localStorage.setItem("navTheme", "success");
    });
    $(".tiles.warning").on("click", function () {
      ...
      $(".tiles").removeClass("selected");
      $(this).addClass("selected");
      localStorage.setItem("navTheme", "warning");
    });
    $(".tiles.danger").on("click", function () {
      ...
      $(".tiles").removeClass("selected");
      $(this).addClass("selected");
      localStorage.setItem("navTheme", "danger");
    });
    ...
    $(".tiles.info").on("click", function () {
      ...
      $(".tiles").removeClass("selected");
      $(this).addClass("selected");
      localStorage.setItem("navTheme", "info");
    });
    ...
    $(".tiles.default").on("click", function () {
      ...
      $(".tiles").removeClass("selected");
      $(this).addClass("selected");
      localStorage.setItem("navTheme", "default");
    });
  });
})(jQuery);
