...
if($_POST['criteria'] == 'all'){
    ...
    foreach($tenant as $tenant){
        ...
        <div id="receipt-sheet" class="receipt-sheet">
            <div id="receipt-inner">
                <h4 align="center"><?php echo $rental_name?></h4>
                <p id="row"><strong id="location"><?php echo $location?></strong><strong><?php echo 'Tel: 0'.$telephone?></strong></p>
                ...
                <input type="hidden" id="tel2" value="<?php echo '0'.$telephone?>">
                <input type="hidden" id="house_number2" value="<?php echo ' '.$house_number?>">
                <input type="hidden" id="amount_received2" value="<?php echo $amount_received?>">
                <input type="hidden" id="balance2" value="<?php echo $balance?>">
                <input type="hidden" id="latest_payment2" value="<?php echo $latest_payment?>">
                <input type="hidden" id="tenant_name" value="<?php echo $tenant_name?>">
                <input type="hidden" id="tenant_phone" value="<?php echo '0'.$tenant_phone?>">
